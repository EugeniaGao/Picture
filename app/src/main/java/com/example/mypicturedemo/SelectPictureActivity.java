...
public class SelectPictureActivity extends AppCompatActivity implements FinalNumInter, View.OnClickListener {
     ...
     */
    private int MAX_NUM;
    private static final int MAX_NUM_IMAGE = 1000;//指定了照片个数
    ...
    private void initData() {
        ...
        Log.d("jing", "initData: "+groupPosition);
        context = this;
        ...
        btnOk.setText(String.format("完成0/%d", MAX_NUM));
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                btnSelect.setText(currentImageFolder.getName());
            }
        });
        getThumbnail();
    }
    ...
    public void ok(View v) {
        if (selectedPicture.size() > 0) {
            ...
            data.putExtra(INTENT_SELECTED_PICTURE, selectedPicture);//将选择的图片路径存放到集合中
            data.putExtra("groupPosition", groupPosition);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PHOTO_RESOULT) {
            ...
            data2.putExtra("groupPosition", groupPosition);
                ...
                if (isSelected) {
                    ...
                    holder.checkBox.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            btnOk.setEnabled(selectedPicture.size() > 0);
                            btnOk.setText(String.format("完成%d/%d", selectedPicture.size(), MAX_NUM));
